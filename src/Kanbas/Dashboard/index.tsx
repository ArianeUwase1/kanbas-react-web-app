  ...
  return (
    <div id="wd-dashboard">
      ...
      <div id="wd-dashboard-courses">
        ...
        <div className="wd-dashboard-course">
          <img src="/images/NLP.jpg" width={200} alt=" NLP" />
          <div>
        ...
        <div className="wd-dashboard-course">
          <img src="/images/7100.jpg" width={200} alt=" Time Series"  />
          <div>
        ...
        <div className="wd-dashboard-course">
          <img src="/images/5140.jpg" width={200} alt="Econometrics" />
          <div>
        ...
        <div className="wd-dashboard-course">
          <img src="/images/5262.jpg" width={200} alt=" Big Data" />
          <div>
        ...
        <div className="wd-dashboard-course">
          <img src="/images/7990.jpg" width={200} alt="Thesis"  />
          <div>
        ...
        <div className="wd-dashboard-course">
          <img src="/images/7305.jpg" width={200} alt="Statistical Physics" />
          <div>
